...
class AlbumController extends Controller
{
	    ...
	    if ($request->hasFile('images')) {
	        ...
	        foreach($request->file('images') as $file){
	                ...
	                $constraint->aspectRatio(); }) )
	            {
	            	...
	            	return redirect('admin/album/index')->with('error', "Image not uploaded.");
	            }
	        ...
	        return redirect('admin/album/index')->with('status', "Image uploaded successfully.");
	    }
	}
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/album/index')->with('success', 'Ads Has Been Deleted');
    }
}
