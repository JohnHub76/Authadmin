...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
			...
			<div class="col-sm-6">
            <a href="{{route('admin.album.create')}}" type="button" class="float-right btn btn-success"><i class="fa fa-folder"></i> Create New Album</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="columns is-mobile">
        <span class="column is-one-half">
        <a href="{{route('admin.album.edit', $album->id)}}" class="button is-primary is-fullwidth"><button type="button" class="btn btn-primary btn-sm" style="width: 61px;"> Edit </button></a></span>
        <span class="column is-one-half">
