      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
			...
			<div class="col-sm-6">
            <a href="{{route('admin.album.index')}}" type="button" class="float-right btn btn-success"><i class="fa fa-folder"></i>View Albums</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
				...
				<form action="{{ route('admin.album.create') }}" method="post" enctype="multipart/form-data">
			        ...
			        <input type="text" class="form-control" name="name" id="album_name" placeholder="Enter Album name">
			      </div>
			    <div class="form-group">
